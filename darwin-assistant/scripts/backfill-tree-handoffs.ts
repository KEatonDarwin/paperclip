...
function buildHandoff(tree: TreeRow, nodes: NodeRow[], docsNode: NodeRow | null): string {
  ...
  return [
    ...
    '## Human runthrough',
    '',
    '- [ ] Open the finished tree in the cockpit, expect the listed branches/artifacts to match the tree result.',
    '- [ ] Follow the "How to use it" steps above, expect the delivered behavior to be visible without reading worker internals.',
    '- [ ] Review the deferred/next-step notes, expect any missing or intentionally skipped scope to be explicit.',
    '',
    '## Next steps / deferred',
    '',
